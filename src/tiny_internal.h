...
#define LOCK_ARRAY_LOG_SIZE 20 /* Size of lock array: 2^10 = 1024 */
#endif
...
static inline stm_word_t int_stm_load(stm_tx_t *tx, volatile stm_word_t *addr)
{
    return stm_wtetl_read(tx, addr);
}

static inline void int_stm_store(stm_tx_t *tx, volatile stm_word_t *addr, stm_word_t value)
{
